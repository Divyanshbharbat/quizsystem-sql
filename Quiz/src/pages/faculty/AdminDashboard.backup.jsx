...
const AdminDashboard = () => {
  ...
  const fetchStudents = async (year = null) => {
    try {
      let url = `${import.meta.env.VITE_APP}/api/student?department=${adminDept}`;
      if (year) {
        url += `&year=${year}`;
      }
  ...
  const handleAddOrUpdateFaculty = async (e) => {
    ...
    try {
      if (editingFaculty) {
        ...
        // Update selected faculty (from view)
        const res = await axios.put(
    ...
    <div className="flex min-h-screen bg-[#f5f6fa] font-sans">
      <div className="flex-grow transition-all duration-300">
        ...
        <main className="p-8 max-w-7xl mx-auto">
          ...
          {/* Fetch and Toggle faculty table */}
          <div className="flex gap-4 mb-6">
            <button
            ...
            <button
              ...
              className="px-5 py-2 bg-[#243278] text-white rounded-md"
            >
          ...
          >
            <h2 className="text-xl font-semibold mb-4">
              {editingFaculty ? "Edit Faculty Data & Password" : selectedFaculty ? "Edit Faculty" : "Add New Faculty"}
            </h2>
            ...
            {editingFaculty && (
              <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
                ...
                <p className="text-xs text-blue-600 mt-1">
                  You can update all details and password below
                </p>
              </div>
            )}
            ...
            >
              ...
              <div className="col-span-2 flex gap-4 flex-wrap">
                ...
                >
                  {editingFaculty ? "Update Faculty Details" : selectedFaculty ? "Update Faculty" : "Add Faculty"}
                </button>
                ...
                {selectedFaculty && !editingFaculty && (
                  <button
                    type="button"
                    className="px-5 py-2 bg-red-600 text-white rounded-md hover:bg-red-700"
